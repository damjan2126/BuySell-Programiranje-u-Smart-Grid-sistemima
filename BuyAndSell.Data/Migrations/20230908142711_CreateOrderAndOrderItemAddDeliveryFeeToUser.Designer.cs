...
namespace BuySell.Data.Migrations
{
    ...
    [Migration("20230908142711_CreateOrderAndOrderItemAddDeliveryFeeToUser")]
    partial class CreateOrderAndOrderItemAddDeliveryFeeToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BuySell.Data.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("BuySell.Data.Entities.Item", "Item")
                        .WithMany("OrderItems")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BuySell.Data.Entities.Order", "Order")
                        .WithMany("Items")
